...
public class SecondaryStoreConfiguration {
    ...
    @Bean
    LocalContainerEntityManagerFactoryBean secondaryEntityManagerFactory(@Qualifier("secondaryDataSource") DataSource dataSource, JpaVendorAdapter jpaVendorAdapter, DbmsSpecifics dbmsSpecifics,
    ...
    @Bean("secondaryLiquibaseProperties")
    @ConfigurationProperties(prefix = "secondary.liquibase")
    public LiquibaseProperties secondaryLiquibaseProperties() {
        return new LiquibaseProperties();
    }

    @Bean("secondaryLiquibase")
    public SpringLiquibase secondaryLiquibase(@Qualifier("secondaryDataSource") DataSource dataSource, @Qualifier("secondaryLiquibaseProperties") LiquibaseProperties liquibaseProperties) {
