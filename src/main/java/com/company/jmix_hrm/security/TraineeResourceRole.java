...
public interface TraineeResourceRole {
    ...
    @EntityAttributePolicy(entityClass = Employee.class, attributes = {"employeeCode", "gender", "dateOfBirth", "department", "manager", "profilePicture"}, action = EntityAttributePolicyAction.MODIFY)
